...
surrogates = [gpt2_small, gpt2_medium, gpt2_large, gpt2_xl]
...
attacker = ImprovedGCG(surrogates, verbose=True, early_return=False, num_steps=100)
attacker.attack()
...
test_harmful_output_rate(
    ...
    [gpt2_small],
    saving_path="./results/gpt_attack/igcgenumerate-vicunatemplate-gradient.json",
    verbose=True,
)
