...
#     answer, logits = vicuna.generate(q, verbose=True, return_logits=True)
#     print(answer)
...
for example_id, (inputs, target) in enumerate(loader):
    ...
    print("-" * 50)
save_testing_result(
    results, f"./results/certify/{args.defender}_{args.model}_{purify_noise_level}.json", verbose_result=False
)
